...
function ele(){
    ...
    upper.style.cssText = `background:url(./images/guan2.png);background-size:50px ;width:50px;height:${Math.round(Math.random()*110+90)}px;
                            position:absolute;top:0;right:0`
    let lower = document.createElement("div") ;
    lower.style.cssText = `background:url(./images/guan3.png);background-size:100%;width:50px;height:${Math.round(Math.random()*100+100)}px;
    ...
    let timer =  setInterval(
        ()=>{
            ...
            if(bird.offsetLeft == lower.offsetLeft + lower.offsetWidth +2 || bird.offsetLeft == lower.offsetLeft + lower.offsetWidth +1){
